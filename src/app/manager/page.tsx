  ...
  async function analyze() {
    ...
    try {
      const res = await fetch('/api/qa', {
        ...
        body: JSON.stringify({ transcript, managerName, studentName, sessionDate }),
      })
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-2xl border border-gray-200 p-6 mb-4">
          ...
          <textarea
            ...
            rows={10}
            placeholder="Вставте транскрипт дзвінка..."
          ...
          <button
            onClick={analyze}
            disabled={loading}
            className="mt-3 w-full bg-violet-600 text-white rounded-lg py-2.5 text-sm font-medium hover:bg-violet-700 disabled:opacity-50"
          >
